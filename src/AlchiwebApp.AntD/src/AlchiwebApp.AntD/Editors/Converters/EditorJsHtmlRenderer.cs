...
/// <summary>
/// Renders the EditorJsRenderFragment component as HTML using a provided HtmlRenderer.
/// </summary>
/// <param name="html_renderer">The HtmlRenderer instance used to render the components.</param>
public sealed partial class EditorJsHtmlRenderer(HtmlRenderer html_renderer)
{
    ...
    public async Task<string> ParseAsync(string value, bool strip_html = false, string? styling_map = "[]")
    {
        ...
        string fragment = await RenderComponentAsHtmlAsync<EditorJsRenderFragment>(parameters);
        ...
        string striped_fragement = tags_expression.Replace(fragment, "");
    ...
    {
        ParameterView parameters = BuildParameters(value, styling_map);
        return await RenderComponentAsHtmlRootComponentAsync<EditorJsRenderFragment>(parameters);
    }
    ...
    private static ParameterView BuildParameters(string value, string? styling_map = "[]")
    {
        ...
        {
            { nameof(EditorJsRenderFragment.Value), value },
            { nameof(EditorJsRenderFragment.StylingMap), styling_map }
        };
    ...
    private Task<HtmlRootComponent> RenderComponentAsHtmlRootComponentAsync<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] T>(ParameterView parameters) where T : IComponent =>
    ...
    private Task<string> RenderComponentAsHtmlAsync<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] T>(ParameterView parameters) where T : IComponent =>
