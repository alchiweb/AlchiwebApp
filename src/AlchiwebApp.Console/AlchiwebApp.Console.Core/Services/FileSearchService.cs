...
public class FileSearchService
{
    ...
    internal bool PerformNormalSearch(string line, string searchText, bool matchCase = false, bool matchWholeWord = false)
    {
    ...
    internal static string ProcessExtendedSearch(string searchText)
    {
        return searchText
            .Replace("\\n", "\n")
            .Replace("\\r", "\r")
